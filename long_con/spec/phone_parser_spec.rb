...
describe Parse do
  ...
  describe Parse do
    it 'should parse number without country code' do
      ...
      expect(return_array).to eq(country: '', area: '345',
                                 prefix: '234', line: '1244', ext: '342')
    end

    it 'should parse number without an ext' do
      return_array = @parse.parse_numbers('1-345-234-1244')
      expect(return_array).to eq(country: '1', area: '345',
                                 prefix: '234', line: '1244', ext: '')
    end
