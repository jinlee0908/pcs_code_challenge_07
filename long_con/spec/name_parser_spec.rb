...
# * 'Dr. Huntington-Smythe'). Do not split hyphenated last names.
  ...
  describe Parse do
    ...
    it 'should parse last names' do
      ...
      expect(return_array).to eq(pre: '', first: '', middle: '',
                                 last: 'Madona', suffix: '')
    end
